        ...
        <div className="w-full max-w-md relative z-10 flex flex-col items-center">
            ...
            >
                ...
                <div className="space-y-4 relative z-10">
                    <h1 className="text-4xl font-extrabold tracking-tight text-slate-950 leading-tight font-outfit">
                        Verifique sua <br />
                ...
                <div className="pt-4 border-t border-slate-50 w-full relative z-10">
                    ...
                    <button
                        ...
                        className={`w-full py-4 font-extrabold text-xs uppercase tracking-widest transition-all border rounded-2xl flex items-center justify-center gap-2 group ${!email
                ...
                <div className="flex items-start gap-4 text-left p-5 bg-violet-50/30 border border-violet-100/50 rounded-[2rem] w-full relative z-10">
                    ...
                    <div className="space-y-1">
                        <h4 className="text-[9px] font-extrabold text-violet-900 uppercase tracking-widest">Atenção</h4>
